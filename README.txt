...
python generate_tfrecord.py --csv_input=B:/BirdBot/BirdModelTraining/birdbotwindows/data/train_labels.csv --image_dir=B:/BirdBot/BirdModelTraining/birdbotwindows/images  --output_path=B:/BirdBot/BirdModelTraining/birdbotwindows/data/train.record

python generate_tfrecord.py --csv_input=B:/BirdBot/BirdModelTraining/birdbotwindows/data/test_labels.csv --image_dir=B:/BirdBot/BirdModelTraining/birdbotwindows/images --output_path=B:/BirdBot/BirdModelTraining/birdbotwindows/data/test.record
...
python export_inference_graph.py --input_type image_tensor --pipeline_config_path training/ssd_mobilenet_v1_fpn.config --trained_checkpoint_prefix training/model.ckpt-30000 --output_directory BirdModel
